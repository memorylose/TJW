...
namespace TJW.Bank
{
    ...
    public class Submit
    {
        ...
        public static string BuildRequest(SortedDictionary<string, string> sParaTemp, string strMethod, string strButtonValue)
        {
            ...
            _log.WriteLog("开始BuildRequest", System.Web.HttpContext.Current.Server.MapPath("/Bank.txt"));

            //待请求参数数组
            Dictionary<string, string> dicPara = new Dictionary<string, string>();
            dicPara = BuildRequestPara(sParaTemp);

            _log.WriteLog("dicPara", System.Web.HttpContext.Current.Server.MapPath("/Bank.txt"));
            ...
            _log.WriteLog("end" + sbHtml.ToString(), System.Web.HttpContext.Current.Server.MapPath("/Bank.txt"));
